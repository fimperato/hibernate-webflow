...
@EnableJpaRepositories(basePackages = {"it.hbn.dao"})
@ComponentScan({ "it.hbn.model","it.hbn.dao","it.hbn.service" })
public class HibernateConfiguration {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[] { "it.hbn.model","it.hbn.dao","it.hbn.service" });
